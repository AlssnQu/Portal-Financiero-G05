// ============================================================
// js/modulos/prestamos.js — Lógica de Préstamos y Simulación
// ============================================================
...
function actualizarGrafico(monto, total, intereses) {
  ...
  if (chartInstancia) {
    ...
    // La variable Chart existe de forma global por el CDN en el HTML
...
/* ───────────────────────────────────────────────────────
   MODAL DE ESTADO — Etapas del proceso
─────────────────────────────────────────────────────── */
const ETAPAS = [
...
const ESTADO_ETAPA = { pendiente: 2, aprobado: 4, rechazado: 4 };
const ESTADO_COLOR = { pendiente: 'warning', aprobado: 'success', rechazado: 'danger' };
const ESTADO_LABEL = { pendiente: 'En evaluación', aprobado: 'Aprobado', rechazado: 'Rechazado' };
